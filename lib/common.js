...
module.exports = function (cfg, deps) {
  ...
  function isLoggedIn(){
    return  usersAccessToken != null || usersToken != null ;
  }
  ...
  function syncAccessToken(newToken){
    usersAccessToken = newToken;
  }
  ...
  function getHeaderToken(){
    if (usersAccessToken){
      return 'bearer '+ usersAccessToken;
    }
    return usersToken;
  }
  ...
  function serviceCallChecks(sadCb, happyCb) {
    if ( isLoggedIn() && hasConnection() ) {
      return happyCb(this.getHeaderToken());
